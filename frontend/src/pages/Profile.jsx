...
const BASE_URL = 'https://expense-tracker-avg2.onrender.com/api';
...
// input change
  ...
  // to change password
  const handleSubmitPasswordSubmit = async(e) => {
    e.preventDefault();
  ...
  {/* Change Password Modal */}
      <Modal
        ...
        className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl relative z-[9999] focus:outline-none flex flex-col mx-4"
        overlayClassName="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9998] flex items-center justify-center p-4"
      ...
      >
        ...
        <form onSubmit={handleSubmitPasswordSubmit} className="space-y-4">
          <PasswordInput
            name="current"
