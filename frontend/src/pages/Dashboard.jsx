...
import { Plus, ArrowUp, ArrowDown, ChevronUp, ChevronDown, Clock, Wallet, TrendingUp, TrendingDown, PiggyBank, BarChart2, ShoppingCart, PieChartIcon, DollarSign } from 'lucide-react';
...
const API_BASE = "https://expense-tracker-avg2.onrender.com/api";
...
// to convert a date to ISO timeline
...
const Dashboard = () => {
  ...
  // function to checkif a date is within the range
  ...
  return (
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        ...
        additonalContent={
          <div className='mt-2 text-xs text-cyan-600 flex itens-center gap-2'>
        ...
        <div className={dashboardStyles.listContainer}>
          <div className={dashboardStyles.listHeader}>
            <h3 className="text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-gray-800 md:mt-3 mt-3 flex items-center gap-3">
              <ArrowDown
               className="w-6 h-6 text-orange-500" /> Recent Expenses{" "}
              <span className={dashboardStyles.listSubtitle}> ({timeFrameRange.label})</span>
            </h3>
