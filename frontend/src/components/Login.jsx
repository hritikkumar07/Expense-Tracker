...
import { loginStyles, profileStyles } from '../assets/dummyStyles.js'
import { CopyPlus, Eye, EyeOff, Lock, Mail, User } from 'lucide-react'
import { Link, useNavigate } from 'react-router-dom';
import axios from 'axios';

const Login = ({onLogin, API_URL = "https://expense-tracker-avg2.onrender.com"}) => {
        ...
        try {
            ...
            if(!profile && token){
                try {
                    ...
                    console.log("Could not fetch profile after login token:", fetchErr);
                    profile = { email };
            ...
            if(typeof onLogin === 'function') {
                try {
                    ...
                    console.log("onLogin threw:", callErr);
                    navigate("/");
